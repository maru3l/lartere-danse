                  ...
                  S.list()
                    ...
                    .items([
                      S.listItem()
                        ...
                        .child(S.documentTypeList("eventType")),
                      S.listItem()
                        .title("Types d'avantage")
                        .child(S.documentTypeList("benefitType")),
                      S.listItem()
                        .title("Types de ressource")
                        .child(S.documentTypeList("ressourceType")),
                    ])
                ),
            ])
        ),
          ...
          S.documentTypeList("ressourceType")
            ...
            .child((categoryId) =>
              S.documentList()
                .title("Ressources")
                .filter(
                  '_type == "ressource" && $categoryId == ressourceType._ref'
                )
                .params({ categoryId })
            )
        ),
